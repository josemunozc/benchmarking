...
install_dir=$HOME/bench/bin/namd/${NAMD_ARCH}-${NAMD_VER}
...
# cd ${build_dir}/charm/$CHARM_ARCH-icc/tests/charm++/megatest
# make pgm
...
# ./configure \
#     --prefix=${build_dir}/fftw \
#     --enable-single \
#     --disable-fortran \
#     CC=icc \
#     CFLAGS="-O3 -march=core-avx2 -fma -ftz -fomit-frame-pointer"
# make clean install
